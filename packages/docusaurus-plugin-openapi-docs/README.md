...
| Name                 | Type      | Default | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| -------------------- | --------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `groupPathsBy`       | `string`  | `null`  | Organize and group sidebar slice by specified option. Note: Currently, `groupPathsBy` contains support for grouping by `tag`, `tagGroup`, and `tagParent` (OpenAPI 3.2 hierarchical tags via `tags[].parent`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| `authPersistence`    | `string` | `"sessionStorage"` | _Optional:_ Determines how auth credentials are persisted. Options: `"localStorage"`, `"sessionStorage"`, or `false` to disable persistence entirely.                                       |
